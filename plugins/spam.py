...
modules_help.append(
    {
        "spam": [
            {"spam [amount of spam]* [spam text]*": "Начать спам"},
            {"statspam [amount of spam]* [spam text]*": "Отправить и удалить"},
            {"fastspam [amount of spam]* [spam text]*": "Начать быстрый спам"},
            {"slowspam [amount of spam]* [spam text]*": "Начать медленный спам"},
        ]
    }
)
